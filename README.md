...
`Warning` - There are two different branches available, go to [main](https://github.com/vasusen-code/Duduffu6/tree/main) branch if you need bot for your `personal` needs.
