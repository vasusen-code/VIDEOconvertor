...
async def source(event):
    await event.edit(source_text,
                    buttons=[[
                         Button.url("FOR PERSONAL USE", url="https://github.com/mohamedhenno/videoconvertor/tree/main"),
                         Button.url("FOR YOUR CHANNEL ", url="https://github.com/mohamedhenno/videoconvertor/")]])
